...
public class DateOfBirth {
    ...
    public static void main(String[] args) {
        exercise.employee.DateOfBirth dateOfBirth = new exercise.employee.DateOfBirth();
        dateOfBirth.setYear(6000);
        dateOfBirth.setMonth(72);
        dateOfBirth.setDay(12);
        System.out.println(dateOfBirth.toString());

        exercise.employee.DateOfBirth dateOfBirth1 = new exercise.employee.DateOfBirth();
        dateOfBirth1.input();
